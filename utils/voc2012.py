...
flags.DEFINE_string('output_file', '../data/tfrecords/voc2012_train.tfrecord', 'output tfrecords directory')
flags.DEFINE_string('classes', '../data/labels/voc2012.names', 'classes names file')
