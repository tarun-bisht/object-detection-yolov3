...
from src.data_generator.downloader import download_images
from src.data_generator.extract_frames import get_frames

flags.DEFINE_boolean("download", False, "Download image from google search")
flags.DEFINE_string(
    "config", "configs/download_config.json", "Path to image download config.json file"
)
