...
from src.yolov3.utils import freeze_all
import src.yolov3.dataset as dataset

flags.DEFINE_string(
    "dataset", "data/dataset/tfrecords/train.tfrecord", "path to train dataset"
)
flags.DEFINE_string(
    "val_dataset", "data/dataset/tfrecords/test.tfrecord", "path to validation dataset"
)
flags.DEFINE_boolean("tiny", False, "yolov3 or yolov3-tiny")
flags.DEFINE_string("weights", "data/models/yolov3/yolov3.tf", "path to weights file")
flags.DEFINE_string("output", "data/models/model", "path to save trained model")
...
def main(_argv):
    ...
    if FLAGS.mode == "eager_tf":
        ...
        for epoch in range(1, FLAGS.epochs + 1):
            ...
            model.save_weights(os.path.join(FLAGS.output, f"yolov3_train_{epoch}.tf"))
    else:
        model.compile(
        ...
        callbacks = [
            ...
            ModelCheckpoint(
                os.path.join(FLAGS.output, "yolov3_train_{epoch}.tf"),
                verbose=1,
